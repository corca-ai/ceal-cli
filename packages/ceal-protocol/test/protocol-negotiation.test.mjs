...
test("protocol negotiation selects the current implemented version", () => {
	assert.deepEqual(negotiateCealProtocol({ minimum: "1.1.0", maximum: "1.1.0" }), {
		schema_version: "ceal.protocol_negotiation.v1",
		ok: true,
		protocol_version: "1.1.0",
	});
	assert.equal(negotiateCealProtocol({ minimum: "0.9.0", maximum: "1.1.0" }).ok, true);
});

test("protocol negotiation rejects non-overlap without guessing another schema", () => {
	for (const range of [
		{ minimum: "0.8.0", maximum: "0.9.9" },
		{ minimum: "1.2.0", maximum: "2.0.0" },
	]) {
...
test("protocol negotiation fails closed on malformed or reversed ranges", () => {
	for (const range of [
		...
		{},
		"1.1.0",
		{ minimum: 1, maximum: "1.1.0" },
		{ minimum: "1", maximum: "1.1.0" },
		{ minimum: "1.1.0", maximum: "1.1.0-next" },
		{ minimum: "2.0.0", maximum: "1.1.0" },
