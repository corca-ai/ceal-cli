...
const LOADER_URL = pathToFileURL(resolve(REPO_ROOT, "test", "source-loader.ts")).href;

const args = process.argv.slice(2);
if (args.length === 0) throw new Error("usage: node test/run-source-tests.ts <test-file-or-glob> [...]");
