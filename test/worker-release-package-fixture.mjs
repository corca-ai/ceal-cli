...
export function packedProtocolFixture(context) {
	...
	const provenance = {
		...
		artifact: {
			package: protocol.name, version: protocol.version, filename: protocol.filename,
			sha256: protocol.sha256, npm_integrity: protocol.integrity, exports: protocol.declared_exports,
		},
	};
	...
	writeFileSync(conformanceProof, `${JSON.stringify({
