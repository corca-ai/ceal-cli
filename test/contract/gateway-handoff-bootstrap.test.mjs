...
import {
	...
	resolveRemoteTag,
} from "../../scripts/bootstrap-gateway-protocol-handoff.mjs";
...
test("the real verifier binds the certificate to workflow, repository, tag, commit, trigger, and issuer", () => {
	const source = readFileSync(new URL("../../scripts/bootstrap-gateway-protocol-handoff.mjs", import.meta.url), "utf8");
	for (const flag of [
