...
test("worker release inventory allows only worker source and a supplied Gateway protocol version", () => {
...
test("worker release inventory rejects every declared Gateway and legacy input", () => {
...
test("worker release inventory rejects a protocol version that is not declared by both worker packages", () => {
	assert.throws(
